...
| **8** | Datos: brewing mixes, damage types, tags (JSON, equivalentes propios no copiados) | `data` (1: MixProvider) + JSONs de `data/apothic_attributes/` | Fases 1-4, 5-6, 7 |
