...
public record StackAttributeModifiers(List<StackAttributeModifiers.Entry> modifiers, boolean showInTooltip) {
    ...
    private static final Codec<StackAttributeModifiers> FULL_CODEC = RecordCodecBuilder.create(
            inst -> inst.group(
                    StackAttributeModifiers.Entry.CODEC.listOf().fieldOf("modifiers").forGetter(StackAttributeModifiers::modifiers),
                    Codec.BOOL.optionalFieldOf("show_in_tooltip", true).forGetter(StackAttributeModifiers::showInTooltip))
    ...
    public static StackAttributeModifiers fromVanilla(ItemAttributeModifiers modifiers) {
        StackAttributeModifiers.Builder builder = builder();
    ...
    public record Entry(Holder<Attribute> attribute, AttributeModifier modifier, EntitySlotGroup slots) {
        public static final Codec<StackAttributeModifiers.Entry> CODEC = Codec.lazyInitialized(
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, StackAttributeModifiers.Entry> STREAM_CODEC = StreamCodec.composite(
                ...
                StackAttributeModifiers.Entry::attribute,
                AttributeModifier.STREAM_CODEC,
                StackAttributeModifiers.Entry::modifier,
                EntitySlotGroup.STREAM_CODEC,
                StackAttributeModifiers.Entry::slots,
